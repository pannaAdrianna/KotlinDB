...
class SignUpActivity : AppCompatActivity() {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (task.isSuccessful) {
                try {
                    ...
                    Log.d("SignUpActivity", "firebaseAuthWithGoogle:" + account.id)
    ...
    fun getFirebaseUser(): FirebaseAuth? {
        return mAuth
    }
        ...
        mAuth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Log.d("SignUpActivity", "signUpWithCredential:success")
//                    tu zacznij jutro
                    ...
                    Log.w("SignUpActivity", "signUpWithCredential:failure")
