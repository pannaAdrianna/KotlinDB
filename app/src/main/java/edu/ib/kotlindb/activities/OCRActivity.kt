...
class OCRActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_ocr_main, menu)
    ...
    private fun pickGallery() {
        ...
        intent.type = "image/*"
        startActivityForResult(intent, OCRActivity.IMAGE_PICK_GALLERY_CODE)
    }
    ...
    private fun requestStoragePermission() {
        ActivityCompat.requestPermissions(this, storagePermission, OCRActivity.STORAGE_REQUEST_CODE)
    }
    ...
    private fun pickCamera() {
        ...
        startActivityForResult(cameraIntent, OCRActivity.IMAGE_PICK_CAMERA_CODE)
    }
    ...
    private fun requestCameraPermission() {
        ...
        ActivityCompat.requestPermissions(this, cameraPermission, OCRActivity.CAMERA_REQUEST_CODE)
    }
